      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-between items-center bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
          <div className="w-full sm:w-1/2">
            <label htmlFor="search-koperasi" className="sr-only">Cari nama koperasi</label>
            <input
              id="search-koperasi"
              type="text"
          ...
          <div className="w-full sm:w-auto flex flex-col sm:flex-row gap-2">
            <label htmlFor="filter-periode" className="sr-only">Filter Periode</label>
            <select
              id="filter-periode"
              value={filterPeriode}
        ...
        <section aria-labelledby="table-heading" className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
          <h2 id="table-heading" className="sr-only">Daftar Data Kesehatan Koperasi</h2>
            ...
            <table className="min-w-full divide-y divide-slate-200 text-sm">
              <thead className="bg-slate-50 text-slate-700 font-bold">
                <tr>
                  ...
                  <th scope="col" className="px-4 py-3 text-center">Status Kesehatan</th>
